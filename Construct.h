...
template <typename ForwardIterator>
void __destroy_aux(ForwardIterator first, ForwardIterator last, _true_type)
{
...
void __uninitialized_fill(ForwardIterator first, ForwardIterator last, const T& val, T1*)
{
...
ForwardIterator __uninitialized_fill_n(ForwardIterator first, Size n, const T& val, T1*)
{
	typedef typename _type_traits<T1>::is_POD_type is_POD;
